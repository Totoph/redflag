...
echo ""
echo "🌐 URLs:"
echo "  📺 Visual Builder: http://$(curl -s ifconfig.me 2>/dev/null):8080/visual_builder.html"
echo "  📡 API:            http://$(curl -s ifconfig.me 2>/dev/null):8000"
echo "  📖 API Docs:       http://$(curl -s ifconfig.me 2>/dev/null):8000/docs"
echo "  🤖 vLLM:           http://$(curl -s ifconfig.me 2>/dev/null):8082"
echo ""
echo "📊 Services:"
...
echo "   http://$(curl -s ifconfig.me 2>/dev/null):8080/visual_builder.html"
echo ""
